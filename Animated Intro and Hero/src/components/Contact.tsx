          ...
          >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-white">Fr. Conceicao Rodrigues College of Engineering<br />Bandra West, Mumbai</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 hover:border-red-600/30 transition-all duration-500">
              ...
              <div className="flex gap-4">
                <button className="p-4 bg-white/5 border border-white/10 hover:border-red-600 hover:bg-red-600/10 transition-all duration-300 hover:scale-110">
            ...
            <div className="bg-gradient-to-r from-red-600/10 to-transparent border border-red-600/20 p-8 hover:border-red-600/40 transition-all duration-500">
              ...
              <p className="text-white/70">
                Building tomorrow's technology today. Join us in shaping the future of robotics and automation.
              </p>
            </div>
          </motion.div>
        </div>
